...
class MutableModule(BaseModule):
    ...
    def bind(self, data_shapes, label_shapes=None, for_training=True,
        ...
        module = Module(self._symbol, self._data_names, self._label_names, logger=self.logger,
                        ...
                        fixed_param_names=self._fixed_param_names)
        # to some extend, bind function means to allocate memory for calculators
    ...
    def fit(self, train_data, eval_data=None, eval_metric='acc',
        ...
        # initialize the curr_model
        self.bind(data_shapes=train_data.provide_data, label_shapes=train_data.provide_label,
                  for_training=True, force_rebind=force_rebind)
        if monitor is not None:
            self.install_monitor(monitor)
        self.init_params(initializer=initializer, arg_params=arg_params, aux_params=aux_params,
                         allow_missing=allow_missing, force_init=force_init, allow_extra=False)
